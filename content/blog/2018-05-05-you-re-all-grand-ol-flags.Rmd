...
color_count("../../static/img/flag_images/fi.png")
```
...
But when we use the 1% cutoff, we see two different shades of blue. They're almost imperceptable to the human eye, and [one represents 35%](https://www.google.com/search?q=%233E5EB9+color) whereas the [other only represents 1.5%](https://www.google.com/search?q=%233D5DA7+color). 

```{r swaziland example}
color_count("../../static/img/flag_images/sz.png")
```
