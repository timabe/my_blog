---
title: '2016: Analyzing my Reading Habits'
author: Tim Abraham
date: '2017-01-03'
slug: 2016-analyzing-my-reading-habits
categories: []
tags: []
description: Let's pull some data on all the books I read last year!
---
...
google_book_info <- function(title, isbn_code, results = 1, api_key) {
  ...
  library(jsonlite)
  api_key = '<My API Key>' # not necessary but probably good if you're going to call the function a lot
